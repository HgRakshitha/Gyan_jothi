...
class WelcomePandaPage extends StatelessWidget {
  const WelcomePandaPage({super.key});
          ...
          SafeArea(
            ...
            child: Column(
              children: [
                ...
                // Middle Section: Panda Image & its Shadow
                Expanded(
                  child: Center(
                    child: Stack(
                      ...
                      children: [
                        // Panda-shaped Gradient Drop Shadow (Darker at bottom)
                        Transform.translate(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Subtitle
                                  const Text(
                                    'Complete activities and collect fun\nrewards for your achievements!',
                            ...
                            GestureDetector(
                              onTap: () => context.go(AppRoutes.welcomeFox),
                              child: CustomPaint(
                                painter: PandaNextButtonBorderPainter(strokeWidth: 3.0),
                                child: Container(
                                  width: 302,
                                  height: 60,
                                  decoration: const BoxDecoration(
                            ...
                            Row(
                              ...
                              children: List.generate(4, (index) {
                                final isActive = index == 2; // 3rd bar is active
                                return Container(
                                  width: 4,
...
class PandaNextButtonBorderPainter extends CustomPainter {
  final double strokeWidth;

  PandaNextButtonBorderPainter({required this.strokeWidth});
