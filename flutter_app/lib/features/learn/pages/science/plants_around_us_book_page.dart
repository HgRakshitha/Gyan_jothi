...
class PlantsAroundUsBookPage extends ConsumerStatefulWidget {
  const PlantsAroundUsBookPage({super.key});

  @override
  ConsumerState<PlantsAroundUsBookPage> createState() => _PlantsAroundUsBookPageState();
}

class _PlantTypeItem {
  final String title;
  final String desc;
...
class _PlantsAroundUsBookPageState extends ConsumerState<PlantsAroundUsBookPage> {
  final PageController _pageController = PageController();
  int _currentPage = 0;

  final List<_PlantTypeItem> _pages = [
    const _PlantTypeItem(
  ...
  void _finishActivity() {
    final success = ref.read(userProvider.notifier).completeActivity('learn_Plants Around Us', 20);
    if (success) {
