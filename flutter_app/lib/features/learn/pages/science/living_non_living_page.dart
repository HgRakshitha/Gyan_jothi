...
class LivingNonLivingPage extends StatelessWidget {
  const LivingNonLivingPage({super.key});
  ...
  static const _materials = <_MaterialItemData>[
    _MaterialItemData(
      ...
      isVideo: false,
      route: AppRoutes.scienceLivingThingsBook,
    ),
    _MaterialItemData(
      ...
      imagePath: AppAssets.englishLetterTrace,
      isVideo: false,
      route: AppRoutes.scienceNonLivingBook,
    ),
    _MaterialItemData(
      title: 'Living or Not?',
      typeLabel: 'Activity',
      ...
      imagePath: AppAssets.englishLetterTrace,
      isVideo: false,
      route: AppRoutes.scienceLivingOrNotActivity,
    ),
    _MaterialItemData(
      title: 'Living things',
      typeLabel: 'Video',
              ...
              Container(
                ...
                child: ClipOval(
                  child: AppAssetImage(
                    ...
                    height: AppSizes.studyMaterialThumbnailSize,
                    fit: BoxFit.cover,
                    fallback: const Icon(Icons.menu_book_rounded, size: 28),
                  ),
                ),
              ),
