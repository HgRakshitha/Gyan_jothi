...
class BuildAFarmPage extends StatefulWidget {
  ...
  @override
  State<BuildAFarmPage> createState() => _BuildAFarmPageState();
}

class _BuildAFarmPageState extends State<BuildAFarmPage> {
  ...
  static const List<({String asset, String label})> _stickerDefs =
    ...
    (asset: AppAssets.artsCraftMakeSceneStickerFarmer, label: 'Farmer'),
    (asset: AppAssets.artsCraftMakeSceneStickerTractor, label: 'Tractor'),
    (asset: AppAssets.artsCraftMakeSceneStickerSheep, label: 'Sheep'),
    (asset: AppAssets.artsCraftMakeSceneStickerCow, label: 'Cow'),
  ];
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'Drag and create your own fun farm.',
                                    textAlign: TextAlign.center,
...
class _FarmStickerChip extends StatelessWidget {
  const _FarmStickerChip({
    required this.assetPath,
    required this.label,
    required this.onTap,
  });
...
class _BuildAFarmDoneButton extends StatelessWidget {
  const _BuildAFarmDoneButton({required this.onPressed});
