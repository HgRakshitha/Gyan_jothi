...
/// Create a Park — scene builder (same shell as [ColorTheTreePage]).
class CreateAParkPage extends StatefulWidget {
  const CreateAParkPage({super.key});

  @override
  State<CreateAParkPage> createState() => _CreateAParkPageState();
}

class _CreateAParkPageState extends State<CreateAParkPage> {
  ...
  static const List<({String asset, String label})> _stickerDefs =
    ...
    (asset: AppAssets.artsCraftMakeSceneStickerFlowers, label: 'Flowers'),
    (asset: AppAssets.artsCraftMakeSceneStickerSwing, label: 'Swing'),
    (asset: AppAssets.artsCraftMakeSceneStickerSlider, label: 'Slider'),
    (asset: AppAssets.artsCraftMakeSceneStickerTree, label: 'Tree'),
  ];
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'Drag and create your own fun place.',
                                    textAlign: TextAlign.center,
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  Positioned.fill(
                                                    child: AppAssetImage(
  assetPath: AppAssets.artsCraftMakeSceneDreamPark,
  fit: BoxFit.cover,
  fallback: ColoredBox(
...
class _CreateAParkDoneButton extends StatelessWidget {
  const _CreateAParkDoneButton({required this.onPressed});
