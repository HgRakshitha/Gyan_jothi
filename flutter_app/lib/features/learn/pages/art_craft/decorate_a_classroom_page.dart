...
/// Decorate a Classroom — scene builder (same layout as [MakeABirthdayPartyPage]).
class DecorateAClassroomPage extends StatefulWidget {
  const DecorateAClassroomPage({super.key});

  @override
  State<DecorateAClassroomPage> createState() => _DecorateAClassroomPageState();
}

class _DecorateAClassroomPageState extends State<DecorateAClassroomPage> {
  ...
  static const List<({String asset, String label})> _stickerDefs =
    ...
    (asset: AppAssets.artsCraftMakeSceneStickerTeacher, label: 'Teacher'),
    (asset: AppAssets.artsCraftMakeSceneStickerAlphabetChart, label: 'Alphabet'),
    (asset: AppAssets.artsCraftMakeSceneStickerBooks, label: 'Books'),
    (asset: AppAssets.artsCraftMakeSceneStickerClock, label: 'Clock'),
  ];
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'Drag items to set up your room.',
                                    textAlign: TextAlign.center,
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  Positioned.fill(
                                                    child: AppAssetImage(
  assetPath: AppAssets.artsCraftMakeSceneDreamClassroom,
  fit: BoxFit.cover,
  fallback: ColoredBox(
...
class _ClassroomStickerChip extends StatelessWidget {
  const _ClassroomStickerChip({
    required this.assetPath,
    required this.label,
    required this.onTap,
  });
...
class _DecorateAClassroomDoneButton extends StatelessWidget {
  const _DecorateAClassroomDoneButton({required this.onPressed});
