...
class CountingPage extends StatelessWidget {
  ...
  static const _materials = <_MaterialItemData>[
    _MaterialItemData(
      title: 'Count with Pictures',
      typeLabel: 'Book',
      coinCount: 20,
      imagePath: AppAssets.mathCountCharts,
      isVideo: false,
      route: AppRoutes.mathCountPictures,
    ),
    _MaterialItemData(
      title: 'Counting Song',
      typeLabel: 'Video',
    ...
    _MaterialItemData(
      ...
      isVideo: false,
      route: AppRoutes.mathCountMatch,
    ),
    _MaterialItemData(
      ...
      imagePath: AppAssets.englishLetterTrace,
      isVideo: false,
      route: AppRoutes.mathCountObjects,
    ),
  ];
              ...
              Container(
                ...
                child: ClipOval(
                  child: AppAssetImage(
                    ...
                    height: AppSizes.studyMaterialThumbnailSize,
                    fit: BoxFit.cover,
                    fallback: const Icon(Icons.format_list_numbered_rounded, size: 28),
                  ),
                ),
              ),
